...
import { X, Link as LinkIcon, Check, Loader2, Trash2 } from 'lucide-react';
...
export function ShareModal({ open, onClose, conversationId, conversationTitle }: Props) {
  ...
  async function create() {
    ...
    try {
      ...
      toast({ title: 'Could not create share link', description: e.message, variant: 'error' });
    } finally {
      setCreating(false);
    }
  }
          ...
          <div className="fixed inset-0 z-[90] grid place-items-center pointer-events-none p-4">
            ...
            >
              <div className="flex items-center justify-between px-5 py-4 border-b border-hairline">
                <div>
                  <p className="font-display text-[20px] tracking-tight leading-none">Share conversation</p>
                ...
                {loading ? (
                  ...
                  <>
                    <p className="text-[12.5px] text-subtle mb-3">
                      Anyone with this link can read this conversation. They can&rsquo;t reply or see your future messages.
                    </p>
                  ...
                  <>
                    <p className="text-[13px] text-subtle mb-5">
                      Create a public read-only link. Recipients won&rsquo;t need an account to read it.
                    </p>
                    <button
                      onClick={create}
                      disabled={creating}
